#!/usr/bin/env Rscript
# Create template training samples for Landsat hierarchical classification
#
# Outputs:
#   data/samples_landsat_step1_landcover.gpkg
#   data/samples_landsat_step2_dense_vegetation.gpkg
#   data/samples_landsat_step3_sparse_vegetation.gpkg
#
# INSTRUCTIONS:
#   1. Run this script to generate templates with placeholder coordinates
#   2. Open each .gpkg in QGIS alongside Landsat imagery (or Google Earth)
#   3. Move/add points to actual locations matching each class
#   4. Aim for at least 50 points per class (more is better)
#   5. Upload to Posit Cloud and run scripts/hierarchical_classification_landsat.R
...
cat("========================================\n")
cat("Training Sample Templates - Landsat\n")
...
# Landsat archive timeline
START_DATE <- as.Date("2015-01-01")
END_DATE   <- as.Date("2025-12-31")

OUTPUT_PREFIX <- "data/samples_landsat"
...
cat("========================================\n")
cat("Landsat Sample Templates Created!\n")
cat("========================================\n\n")
...
cat("Date range: 2015-01-01 to 2025-12-31 (same for all samples)\n\n")

cat("Upload to Posit Cloud, then run:\n")
cat("  source('scripts/hierarchical_classification_landsat.R')\n")
